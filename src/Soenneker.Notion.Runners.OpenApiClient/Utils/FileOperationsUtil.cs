...
using Soenneker.Notion.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Notion.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public FileOperationsUtil(ILogger<FileOperationsUtil> logger, IConfiguration configuration, IGitUtil gitUtil, IDotnetUtil dotnetUtil,
        IProcessUtil processUtil, IFileDownloadUtil fileDownloadUtil, IFileUtil fileUtil, IDirectoryUtil directoryUtil, IKiotaUtil kiotaUtil, IOpenApiFixer openApiFixer)
    {
        _logger = logger;
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Notion:ClientGenerationUrl"] ?? "https://developers.notion.com/openapi.json";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "NotionOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
